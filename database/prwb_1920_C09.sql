...
--
-- HÃ´te : 127.0.0.1
-- GÃ©nÃ©rÃ© le :  mar. 03 dÃ©c. 2019 Ã  15:32
...
--
-- Base de donnÃ©es :  `prwb_1920_C09`
--
DROP DATABASE IF EXISTS `prwb_1920_C09`;
CREATE DATABASE IF NOT EXISTS `prwb_1920_C09` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `prwb_1920_C09`;
...
--
-- DÃ©chargement des donnÃ©es de la table `post`
--
...
(1, 'ben', '56ce92d1de4f05017cf03d6cd514d6d1', 'BenoÃ®t Penelle', 'ben@test.com'),
...
--
-- DÃ©chargement des donnÃ©es de la table `vote`
--
